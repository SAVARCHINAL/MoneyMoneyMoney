...
preload() {
  ...
  this.npc1.addSingleInteraction("in 2018 14.5 million tons of plastic were contributed to landfill as the hands of consumer culture. Pick up the single-use plastics to clean the city.");
...
class Walkscreen2Room extends PNGRoom {
  preload() {
    this.npc2 = new NPC("celluser1", 1000, 500, 'grab/celluser1.png','grab/celluser2.png');
      ...
      this.npc4.addSingleInteraction("I am making so much money in tech sales!");


      this.npc5 = new NPC("celluser3", 700, 600, 'grab/cell2user1.png','grab/cell2user4.png');
      this.npc5.addSingleInteraction("The Kardashians got bbl's now I want a bbl!");
